...
},{"core-js/library/fn/object/define-property":"v7pm"}],"n5FU":[function(require,module,exports) {
...
},{"@babel/runtime-corejs2/core-js/object/define-property":"eIqn"}],"tuDi":[function(require,module,exports) {
...
},{"@babel/runtime-corejs2/core-js/promise":"eOfj"}],"c6mp":[function(require,module,exports) {
...
},{"@babel/runtime-corejs2/core-js/symbol":"mr6k","@babel/runtime-corejs2/core-js/symbol/iterator":"uGl8"}],"yOG5":[function(require,module,exports) {
var $export = require('./_export');
// 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
...
},{"core-js/library/fn/object/create":"cjsw"}],"BtHH":[function(require,module,exports) {
...
},{"../helpers/regeneratorRuntime":"s7dd"}],"Bdru":[function(require,module,exports) {
...
function Canvas(selector) {
  ...
  var viewport = stateManager.getInstance("viewport");
  function getNode() {
  ...
  function define() {
    var constraints = viewport.get().getConstraints();
    var node = getNode();
...
function Viewport(selector) {
  var getCurrentConstraints = selector === "window" ? getWindowConstraints : getNodeConstraints;
  ...
  function getNodeConstraints() {
    var _document$querySelect = document.querySelector(selector).getBoundingClientRect(),
  ...
  function getConstraints() {
    var _getCurrentConstraint = getCurrentConstraints(),
      width = _getCurrentConstraint.width,
      height = _getCurrentConstraint.height;
    return {
      width: width,
      height: height
    };
...
},{"@babel/runtime-corejs2/core-js/object/freeze":"LJ37"}],"N484":[function(require,module,exports) {
'use strict';
var ctx = require('./_ctx');
var $export = require('./_export');
var toObject = require('./_to-object');
...
},{"@babel/runtime-corejs2/core-js/symbol":"mr6k","@babel/runtime-corejs2/core-js/symbol/iterator":"uGl8"}],"TvDM":[function(require,module,exports) {
...
},{"@babel/runtime-corejs2/core-js/array/from":"ybNn","./arrayLikeToArray.js":"TvDM"}],"vuZA":[function(require,module,exports) {
...
},{"./arrayWithHoles.js":"jsWr","./iterableToArrayLimit.js":"WgV3","./unsupportedIterableToArray.js":"Q4vU","./nonIterableRest.js":"vuZA"}],"N3sD":[function(require,module,exports) {
...
},{"core-js/library/fn/parse-int":"ZL0m"}],"tKBt":[function(require,module,exports) {
"use strict";
...
exports.splitRgbColors = splitRgbColors;
...
function getObjectKey(obj, key) {
  var validProperty = obj.hasOwnProperty(key);
...
function splitRgbColors(rgb) {
  var _rgb$replace$split = rgb.replace(/[()rgb]/g, "").split(","),
    _rgb$replace$split2 = (0, _slicedToArray2.default)(_rgb$replace$split, 3),
    r = _rgb$replace$split2[0],
    g = _rgb$replace$split2[1],
    b = _rgb$replace$split2[2];
  return {
    r: r,
    g: g,
    b: b
...
},{"@babel/runtime-corejs2/helpers/slicedToArray":"vwJD","@babel/runtime-corejs2/core-js/parse-int":"TiYh"}],"GwJL":[function(require,module,exports) {
"use strict";
...
function Logic() {
  var stateManager = this;
  var constants = stateManager.getInstance("constants");
  var particleColor = constants.get().get().color;
  function init() {
    updateStars();
    drawStars();
  }
  ...
  function drawStars() {
    var stars = stateManager.getInstance("stars");
    var ctx = stateManager.getInstance("canvas").get().getCtx();
    var _iterator = _createForOfIteratorHelper(stars.get().get()),
      _step;
    try {
      var _loop = function _loop() {
        var star = _step.value;
        if (!star) return "continue";
        var rgb = utils.isRgba(particleColor) || utils.isRgb(particleColor) ? utils.splitRgbColors(particleColor) : utils.hexToRgb(particleColor);
        var colorWith = function colorWith(opacity) {
          return "rgba(".concat(rgb.r, ", ").concat(rgb.g, ", ").concat(rgb.b, ", ").concat(star.brightness / 100 * opacity, ")");
        };
        var shadowLength = 1;
        var gradualBrightnessLost = 0.2;
        var shadowPositionLost = 10;
        var fills = (0, _from.default)({
          length: shadowLength
        }).map(function (_, i) {
          return colorWith(1 - i * gradualBrightnessLost);
        });
        fills.forEach(function (fill, i) {
          ctx.beginPath();
          var lost = i * shadowPositionLost;
          ctx.fillStyle = fill;
          ctx.rect(star.position.x + lost, star.position.y + lost, star.size, star.size);
          ctx.fill();
        });
      };
  ...
  function updateStars() {
    ...
    var stars = stateManager.getInstance("stars");
    var constraints = viewport.get().getConstraints();
    for (var i = 0; i < stars.get().get().length; i++) {
      var star = stars.get().get()[i];
      if (star === undefined) {
        if (stars.get().get().length > constants.get().get().maxCount) {
          stars.get().clear();
          return;
        }
        var randomX = utils.randomInt(0, 10) <= 9;
        var velocity = utils.randomInt(1, 8);
        if (randomX) {
          stars.get().set(i, stars.get().create(utils.randomInt(80, 100), utils.randomInt(0, constraints.width), constraints.height, velocity));
        } else {
          stars.get().set(i, stars.get().create(utils.randomInt(80, 100), constraints.width, utils.randomInt(0, constraints.height), velocity));
        }
      } else {
        var _star$position = star.position,
          x = _star$position.x,
          y = _star$position.y,
          brightness = star.brightness;
        var newBrightness = brightness - utils.randomInt(100, 1000) / 1000;
        var newSize = star.size - utils.randomInt(5, 10) / 100;
        if (x + star.size < 0 || y + star.size < 0 || newSize <= 0) {
          stars.get().set(i, undefined);
        } else {
          stars.get().set(i, stars.get().create(newBrightness, x + -star.velocity / 3, y + -star.velocity, star.velocity, newSize));
        }
      }
    }
  }
...
},{"@babel/runtime-corejs2/core-js/array/from":"ybNn","@babel/runtime-corejs2/core-js/object/freeze":"LJ37","@babel/runtime-corejs2/core-js/symbol":"mr6k","@babel/runtime-corejs2/core-js/symbol/iterator":"uGl8","@babel/runtime-corejs2/core-js/array/is-array":"BpbX","./utils":"tKBt"}],"vMwj":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = RequestFrameRate;
var _freeze = _interopRequireDefault(require("@babel/runtime-corejs2/core-js/object/freeze"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
...
var _freeze = _interopRequireDefault(require("@babel/runtime-corejs2/core-js/object/freeze"));
var _requestFrameRate = _interopRequireDefault(require("./requestFrameRate"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function Engine(logic) {
  var frameRate = (0, _requestFrameRate.default)(update);
  function start() {
    logic.init();
    frameRate.start();
  }
...
function Animation() {
  var stateManager = this;
  function start() {
    var canvas = stateManager.getInstance("canvas");
    canvas.get().define();
    var stars = stateManager.getInstance("stars");
    var logic = _logic.default.call(stateManager);
    var engine = (0, _engine.default)(logic);
    engine.start();
    window.addEventListener("resize", function () {
      return canvas.get().define();
    });
    window.onpointerdown = function (e) {
      stars.get().add(stars.get().create(100, e.clientX, e.clientY, (0, _utils.randomInt)(1, 8)));
    };
  }
  var self = {
    start: start
...
var _freeze = _interopRequireDefault(require("@babel/runtime-corejs2/core-js/object/freeze"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function Constants(size, maxCount, color) {
  function get() {
    return {
      size: size,
      maxCount: maxCount,
...
function State() {
  ...
  function getKey(key) {
    return (0, _utils.getObjectKey)(state, key);
  }
  var self = {
    get: get,
    set: set,
...
function StateManager() {
  ...
  function createInstance(key) {
    ...
    var stateInstance = (0, _state.default)(initialState);
...
function Stars() {
  var stateManager = this;
  var constants = stateManager.getInstance("constants");
  var stars = (0, _from.default)({
    length: constants.get().get().maxCount
  });
  function create(brightness, x, y, velocity) {
    var size = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : constants.get().get().size;
    var position = {
      x: x,
      y: y
    };
    if (!size) {
      var _constants$get$get = constants.get().get(),
        constantSize = _constants$get$get.size;
      size = (0, _utils.randomInt)(constantSize - constantSize / 3, constantSize + constantSize / 3);
    }
    return {
...
var _viewport = _interopRequireDefault(require("./components/viewport"));
...
var _stateManager = _interopRequireDefault(require("./components/stateManager"));
var _stars = _interopRequireDefault(require("./components/stars"));
var _siteConfig = _interopRequireDefault(require("../site.config.json"));
var utils = _interopRequireWildcard(require("./components/utils"));
function _getRequireWildcardCache(nodeInterop) { if (typeof WeakMap !== "function") return null; var cacheBabelInterop = new WeakMap(); var cacheNodeInterop = new WeakMap(); return (_getRequireWildcardCache = function (nodeInterop) { return nodeInterop ? cacheNodeInterop : cacheBabelInterop; })(nodeInterop); }
function _interopRequireWildcard(obj, nodeInterop) { if (!nodeInterop && obj && obj.__esModule) { return obj; } if (obj === null || typeof obj !== "object" && typeof obj !== "function") { return { default: obj }; } var cache = _getRequireWildcardCache(nodeInterop); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (key !== "default" && Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function ownKeys(object, enumerableOnly) { var keys = (0, _keys.default)(object); if (_getOwnPropertySymbols.default) { var symbols = (0, _getOwnPropertySymbols.default)(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return (0, _getOwnPropertyDescriptor.default)(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { (0, _defineProperty3.default)(target, key, source[key]); }) : _getOwnPropertyDescriptors.default ? (0, _defineProperties.default)(target, (0, _getOwnPropertyDescriptors.default)(source)) : ownKeys(Object(source)).forEach(function (key) { (0, _defineProperty2.default)(target, key, (0, _getOwnPropertyDescriptor.default)(source, key)); }); } return target; }
...
function _fetchData() {
  _fetchData = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
    var _window, innerWidth, data, headerText, mainText, footerText, loading, particlesColor, song;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _window = window, innerWidth = _window.innerWidth;
            data = _siteConfig.default;
            ...
            particlesColor = data.particles.color;
            song = data.song;
            setMusic(song);
...
function getRgbaFromAny(color, alpha) {
  function getRgbaFromRgb(rgb) {
    var _utils$splitRgbColors = utils.splitRgbColors(rgb),
      r = _utils$splitRgbColors.r,
      g = _utils$splitRgbColors.g,
      b = _utils$splitRgbColors.b;
    return "rgba(".concat(r, ", ").concat(g, ", ").concat(b, ", ").concat(alpha, ")");
  }
  var result = utils.isRgba(color) ? color : utils.isRgb(color) ? getRgbaFromRgb(color) : function () {
    var parsed = utils.hexToRgb(color);
    return getRgbaFromRgb("rgb(".concat(parsed.r, ", ").concat(parsed.g, ", ").concat(parsed.b, ")"));
  }();
  return result;
}
function setFireColor(color) {
  var defaultAlpha = 0.5;
  var finalColor = getRgbaFromAny(color, defaultAlpha);
  var fire = document.getElementById("fire");
  fire.style.background = "linear-gradient(to top, ".concat(finalColor, ", transparent)");
}
function setCssVariables(color) {
  var rgb = utils.isRgba(color) || utils.isRgb(color) ? utils.splitRgbColors(color) : function () {
    var parsed = utils.hexToRgb(color);
    return parsed;
  }();
  var hsl = utils.rgbToHsl(rgb.r, rgb.g, rgb.b);
  var titleColor = _objectSpread(_objectSpread({}, hsl), {}, {
    l: 90
  });
  var textColor = _objectSpread(_objectSpread({}, hsl), {}, {
    l: 85
  });
  var newRgb = utils.hslToRgb(hsl.h, hsl.s, 85);
  document.documentElement.style.setProperty("--title-color", "hsl(".concat(titleColor.h, ", ").concat(titleColor.s, "%, ").concat(titleColor.l, "%)"));
  document.documentElement.style.setProperty("--text-color", "hsl(".concat(textColor.h, ", ").concat(textColor.s, "%, ").concat(textColor.l, "%)"));
  document.documentElement.style.setProperty("--light-text-color", "rgba(".concat(newRgb.r, ", ").concat(newRgb.g, ", ").concat(newRgb.b, ", 0.5)"));
}
function enableBackground(selector, size, maxCount, color) {
  var context;
  var stateManager = (0, _stateManager.default)();
  stateManager.createInstance("viewport", (0, _viewport.default)(selector));
  stateManager.createInstance("constants", (0, _constants.default)(size, maxCount, color));
  context = stateManager;
  stateManager.createInstance("canvas", _canvas.default.apply(context, [selector]));
  stateManager.createInstance("stars", _stars.default.apply(context));
  context = stateManager;
  var animation = _animation.default.apply(context);
  animation.start();
}
var showText = false;
var birthPageIndex = 0;
function initToggleText() {
  var birth = document.querySelector('.birth-toggle');
  birth.onclick = function () {
    showText = !showText;
    birthPageIndex = 0;
    var birthPage = document.querySelectorAll('.birth');
    var birthText = document.querySelector('.birth-text');
    var birthTitle = document.querySelector('.birth-title');
    var list = document.querySelectorAll(".homepage");
    if (showText) {
      list.forEach(function (e) {
        e.classList.remove("visible");
        e.classList.add("hidden");
      });
      birthPage.forEach(function (e) {
        e.classList.remove('hidden');
        e.classList.add('visible');
      });
      birthTitle.innerText = _siteConfig.default.birth[birthPageIndex].title;
      birthText.innerText = _siteConfig.default.birth[birthPageIndex].content;
    } else {
      list.forEach(function (e) {
        e.classList.remove("hidden");
        e.classList.add("visible");
...
function initToogleNext() {
  var next = document.querySelector('.birth-next');
  next.onclick = function () {
    var birthText = document.querySelector('.birth-text');
    var birthTitle = document.querySelector('.birth-title');
    var isLastPageOnClick = birthPageIndex == _siteConfig.default.birth.length - 1;
    ...
    birthPageIndex++;
    var valid = _siteConfig.default.birth.length > birthPageIndex;
    if (valid) {
      birthTitle.innerText = _siteConfig.default.birth[birthPageIndex].title;
      birthText.innerText = _siteConfig.default.birth[birthPageIndex].content;
    }
    if (birthPageIndex == _siteConfig.default.birth.length - 1) {
      next.innerText = "  🎂  ";
    }
  };
}
